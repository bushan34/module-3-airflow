...
SQL_CONTEXT = {
    'LOAD_VIEW_PAYMENT_ONE_YEAR': """
          create or replace view nnaranov.view_payment_yr_{{ execution_date.year }} as (
            with staging as (
            ...
            'HUB_USER':  """
                    with row_rank_1 as (
                         select * from (
                                 ...
                                 from nnaranov.view_payment_yr_{{ execution_date.year }}         
    ...
    'LINKS': {
            'LINK_USER_ACCOUNT_BILLING_PAY':  """
                      with records_to_insert as (
                          ...
                          from nnaranov.view_payment_yr_{{ execution_date.year }} as stg 
    ...
    'DROP_VIEW_PAYMENT_ONE_YEAR': """
          drop view if exists nnaranov.view_payment_yr_{{ execution_date.year }};
     """
}
